...
# Configuration
new_data_dir = "../images/attempt3_augmented_training_set_final"  # Path to the new dataset directory
model_save_path = "./models/v4_efficientnet_b2_finetuned_new.pth"
pretrained_model_path = "./models/v3_efficientnet_b2_finetuned_new.pth"
batch_size = 16
learning_rate = 1e-4
