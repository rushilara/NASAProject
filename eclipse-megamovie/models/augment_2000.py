...
# Configuration
input_dir = "../images/test_to_training_images"  # Input directory for the smaller dataset
output_dir = "../images/augmented_2000"  # Output directory for augmented images
target_counts = {
    0: 400,
    1: 300,
    2: 300,
